...
public class Rey_Lanzatonio extends Tropa {
    ...
    private String nombre = "Rey_Lanzatonio";
    private int vida = 950;
    private int ataque_base = 150;
    private double daño_critico = 1.5;
    private double probabilidad_de_critico = 0.50;
    private boolean aereo = false;
    private boolean estado_de_vida = true;
    private String rutaviva = "recursos/rey/rey_lanzatonio.png";
